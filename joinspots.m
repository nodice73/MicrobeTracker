...
setcontrols
    ...
    function run(hObject, eventdata)
        ...
        if get(handles.main.ifilecheck,'Value') && exist(params.ifolder,'file')==2
            images = loadimagestack(params.ifolder,1);
    ...
    function export(hObject, eventdata)
        [spotList,spotList2] = getSpotList(cellList,params.spotsfield,params.pix2mu);
...
function [spotList,spotList2] = getSpotList(cellList,field,pix2mu)
    ...
    function s = trackonespot(frame,spot)
        ...
        while true
            ...
            s{1}.abspos = [s{1}.abspos abspos.*pix2mu];
            s{1}.reld = [s{1}.reld reld];
            s{1}.absd = [s{1}.absd absd.*pix2mu];
